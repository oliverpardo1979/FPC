...
\begin{itemize}
  \item El SGP atado a los ingresos corrientes de la Nación genera un \textbf{automatismo de gasto}: mayores ingresos $\Rightarrow$ mayores transferencias.
...
%  \item Avanzar en \textbf{autonomía tributaria territorial}.
  ...
  \begin{itemize}
    \item Reducir tarifa general del IVA (19\% $\rightarrow$ 16\%).
    \item Eliminar ICA
