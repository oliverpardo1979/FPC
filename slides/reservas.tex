...
\end{tikzpicture}
\vspace{0.1cm}
\par\scriptsize\textit{Fuente: ejecución presupuestal del rezago con recursos de la Nación, MHCP. El MFMP 2026 no publica una serie comparable con corte de 2025.}
\end{figure}
\end{frame}
